          ...
          <div>
            <div className='w-full bg-grey pb-[100%] '>
                ...
                <div className='flex ' >
                  ...
                  <p className="font-prompt phone:text-sm sm:text-xl  md:text-xl xl:text-xl  pr-[10%]  pb-2">ยอดเงินคงเหลือ</p>
                  <div className=' flex'>
                    <div className='pr-2'>
                      <Button  
                  ...
                  <div className='flex flex-col'>
                    <div className="flex justify-between ">
                      <p className="font-prompt phone:text-xs  sm:text-md md:text-2xl ">ช่วงเวลา</p>
                      <p className="font-prompt phone:text-xs  sm:text-md md:text-2xl ">รายการ</p>
                      <p className="font-prompt phone:text-xs  sm:text-md md:text-2xl ">ยอดรายการ</p>
                      <p className="font-prompt phone:text-xs  sm:text-md md:text-2xl ">สถานะ</p>
                      <p className="font-prompt phone:text-xs  sm:text-md md:text-2xl ">ยอดคงเหลือ</p>
                    </div>
                    <div className='border border-bgrey'></div>
                  </div>
                  <div className='flex flex-col pt-[2%]'>
                    <div className="flex justify-between ">
                      <p  className="font-prompt phone:text-xs  sm:text-sm  md:text-2xl">25/กค/2567</p>
                      <p  className="font-prompt phone:text-xs  sm:text-md md:text-2xl">เติมเงินเข้าบัญชี</p>
                      <p  className="font-prompt phone:text-xs  sm:text-md md:text-2xl">+ ฿88</p>                
                      <button  className='bg-green rounded-2xl w-[15%] h-[10%]'>
                        <p className="font-prompt phone:text-xs  sm:text-sm md:text-2xl">Success</p>

                      </button>    
                      <p  className="font-prompt phone:text-xs  sm:text-sm md:text-2xl">฿99999</p>
