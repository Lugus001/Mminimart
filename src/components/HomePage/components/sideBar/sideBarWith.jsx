  ...
  return (
    <div className='w-[50%] bg-grey'>
        ...
        <div className=' pl-[8%]  pr-[5%]'>
            <div className='flex '>
              <button>
                <svg className="w-full  text-gray-800 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0 0a8.949 8.949 0 0 0 4.951-1.488A3.987 3.987 0 0 0 13 16h-2a3.987 3.987 0 0 0-3.951 3.512A8.948 8.948 0 0 0 12 21Zm3-11a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>
                </svg>
              </button>
              <div className='pl-[1rem] pt-[2rem]'>
                <p className='font-prompt  md:text-xl xl:text-xl font-extrabold' href="ชื่อร้านค้า">ร้านทศกัณ</p>
                <p className='font-prompt  md:text-2xl xl:text-2xl  pb-3' href="ชื่อร้านค้า">นายทศกัณ มานะ</p>
                <p className='font-prompt text-xl pt-3' href="วันที่สมัคร">สมัครวันที่</p>
              </div>
              </div>
              ...
              <div>
              <button onClick={handleRemainingฺOpen} type='button' className={`sidebar-button ${clickedButton === 'remaining' ? 'text-orange' : ''}`}>
              <div className='p-5 w-full flex'>
                    ...
                    <p className='font-prompt  md:text-xl xl:text-2xl pl-[0.5rem] '>ยอดเงินคงเหลือ</p>
                 </div>
              </button>
            </div>

            <div>
            <button onClick={handlePersonOpen} type='button' className={`sidebar-button ${clickedButton === 'person' ? 'text-orange' : ''}`}>
            <div className='p-5 w-full flex'>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className='font-prompt  md:text-xl xl:text-2xl pl-[0.5rem] '>ข้อมูลส่วนตัว</p>
                 </div>
              </button>
            </div>

            <div>
            <button onClick={handleOrderListOpen} type='button' className={`sidebar-button ${clickedButton === 'orderList' ? 'text-orange' : ''}`}>
              <div className='p-5 w-full flex'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0 0 13.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v0a.75.75 0 0 1-.75.75H9a.75.75 0 0 1-.75-.75v0c0-.212.03-.418.084-.612m7.332 0c.646.049 1.288.11 1.927.184 1.1.128 1.907 1.077 1.907 2.185V19.5a2.25 2.25 0 0 1-2.25 2.25H6.75A2.25 2.25 0 0 1 4.5 19.5V6.257c0-1.108.806-2.057 1.907-2.185a48.208 48.208 0 0 1 1.927-.184" />
                    </svg>
                    <p className='font-prompt  md:text-xl xl:text-2xl pl-[0.5rem]  '>รายการคำสั่งซื้อ</p>
                 </div>
              </button>
            </div>

            <div>
            <button onClick={handleDeliveryOpen} type='button'className={`sidebar-button ${clickedButton === 'delivery' ? 'text-orange' : ''}`}>
              <div className='p-5 w-full flex'>
                 <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className='font-prompt  md:text-xl xl:text-2xl pl-[0.5rem] '>เช็คสถานะการจัดส่ง</p>
                 </div>
              </button>
            </div>
            ...
            <div className='p-5 w-full flex'>
                 <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"> 
                  <path d="M2 18C1.45 18 0.979167 17.8042 0.5875 17.4125C0.195833 17.0208 0 16.55 0 16V2C0 1.45 0.195833 0.979167 0.5875 0.5875C0.979167 0.195833 1.45 0 2 0H8C8.28333 0 8.52083 0.0958333 8.7125 0.2875C8.90417 0.479167 9 0.716667 9 1C9 1.28333 8.90417 1.52083 8.7125 1.7125C8.52083 1.90417 8.28333 2 8 2H2V16H8C8.28333 16 8.52083 16.0958 8.7125 16.2875C8.90417 16.4792 9 16.7167 9 17C9 17.2833 8.90417 17.5208 8.7125 17.7125C8.52083 17.9042 8.28333 18 8 18H2ZM14.175 10H7C6.71667 10 6.47917 9.90417 6.2875 9.7125C6.09583 9.52083 6 9.28333 6 9C6 8.71667 6.09583 8.47917 6.2875 8.2875C6.47917 8.09583 6.71667 8 7 8H14.175L12.3 6.125C12.1167 5.94167 12.025 5.71667 12.025 5.45C12.025 5.18333 12.1167 4.95 12.3 4.75C12.4833 4.55 12.7167 4.44583 13 4.4375C13.2833 4.42917 13.525 4.525 13.725 4.725L17.3 8.3C17.5 8.5 17.6 8.73333 17.6 9C17.6 9.26667 17.5 9.5 17.3 9.7L13.725 13.275C13.525 13.475 13.2875 13.5708 13.0125 13.5625C12.7375 13.5542 12.5 13.45 12.3 13.25C12.1167 13.05 12.0292 12.8125 12.0375 12.5375C12.0458 12.2625 12.1417 12.0333 12.325 11.85L14.175 10Z" fill="#111928"/>
                    ...
                    <p className='font-prompt  md:text-xl xl:text-2xl pl-[0.5rem]  '>ออกจากระบบ</p>
                 </div>
              </button>
            </div>
